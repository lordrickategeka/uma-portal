            ...
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
                        ...
                        <p>A fully registered medical practitioner who has met all financial obligations to the Association as outlined in the Constitution.</p>
                    </div>
                    <div class="col-auto">
                ...
                @foreach ($plans as $plan)
                    ...
                    <div class="membership-category">
                        ...
                        <ul>
                            <li><strong>Membership Fee:</strong> UGX {{ number_format($plan->price, 0) }} (one-time payment)</li>
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="stat text-success">
                            ...
                            <i class="align-middle" data-feather="thumbs-up" style="color: {{ $activePlan ? 'green' : 'gray' }}"></i>
                        </div>
                    </div>
                </div>
