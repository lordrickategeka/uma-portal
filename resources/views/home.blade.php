...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        @else
            <div class="bg-danger text-white px-4 py-2 rounded" style="min-width: 200px; text-align: center;">
            ...
            <div class="col-6 col-lg-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <small class="text-muted">All blog posts</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <small class="text-muted">Published publications</small>
                    </div>
                </div>
            </div>
        </div>
