                            ...
                            <div class="card-body">
                                ...
                                <div class="app-brand justify-content-center">
                                    <a href="index.html" class="app-brand-link gap-2">
                                        ...
                                        <span class="app-brand-text demo text-body fw-bolder">UMA PP</span>
                                    </a>
                                </div>
                                <!-- /Logo -->
                                <h4 class="mb-2">Adventure starts here 🚀</h4>
                                <p class="mb-4">We are glad to have you back!</p>

                                <form role="form" id="formAuthentication" class="mb-3" action="{{ route('login') }}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 form-password-toggle">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="password"
                                                ...
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                required aria-describedby="password" required
