...
<head>
    ...
    <title>UMA PP DASH</title>

    <link href="{{ asset('dashtheme/css/app.css') }}" rel="stylesheet">
...
<body>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                ...
                                <span class="text-dark">Hello,
                                    {{ optional(Auth::user())->first_name ?? 'Guest' }}</span>
    ...
    <script src="{{ asset('dashtheme/js/app.js') }}"></script>
